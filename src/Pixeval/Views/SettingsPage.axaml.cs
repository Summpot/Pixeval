...
public partial class SettingsPage : UserControl
{
    ...
    {
        InitializeComponent();
        LocalGroups = SettingsBuilder.CreateGroupList(App.AppViewModel.AppSettings)
        ...
        foreach (var group in LocalGroups.Concat(ExtensionGroups))
        {
            ...
            foreach (var entry in group)
                StackPanel.Children.Add(SettingsEntryHelper.GetControl(entry));
        }
    }
    ...
    private void SettingsCard_OnClick(object? sender, RoutedEventArgs e)
    {
        ...
        if (settingsCard.HeaderIcon is null)
            settingsCard.HeaderIcon = new SymbolIcon() { Symbol = Symbol.AccessTime };
        else
