...
public abstract class PersistentManagerBase<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.All)] TEntry, TModel> : IPersistentManager<TEntry, TModel> where TEntry : HistoryEntry, new()
{
    ...
    private static void CreateTableIfNotExists<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.All)] TTable>(SQLiteConnection db) where TTable : new()
    {
